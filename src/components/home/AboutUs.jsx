        ...
        <MainContentContainer noPadding>
            ...
            <Container>
                <Box sx={{ flexGrow: 1, overflow: 'hidden', px: 3 }}>
                    ...
                    <p>
                        To create a community of Home Cooks, Chefs, Foodies,
                        Grillers, and Microwavers to unite and create their own
                        recipes to share with the world.
                    </p>
                    <h2>Our Goal:</h2>
                    <p>
                        We understand with cooking it's all about the taste. At
                        Click-N-Cook we are here to help spread the love and
                        enjoyment of cooking to all of our users and help bring
                        cooks of all levels together.
                    </p>
